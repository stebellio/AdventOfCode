...
for(number of numbers) {
    for(secondNumber of numbers) {
        var sum = parseInt(number) + parseInt(secondNumber);
        if (sum == 2020) {
            result[0] = parseInt(number);
            result[1] = parseInt(secondNumber);
        }
    }
}

var solution = result[0] * result[1];
console.log(solution);

// for(number of numbers) {
//     for(secondNumber of numbers) {
//         for(thirdNumber of numbers) {
//             var sum = parseInt(number) + parseInt(secondNumber) + parseInt(thirdNumber);
//             if (sum == 2020) {
//                 result[0] = parseInt(number);
//                 result[1] = parseInt(secondNumber); 
//                 result[2] = parseInt(thirdNumber); 
//             }
//         }
//     }
// }

// solution = result[0] * result[1] * result[2];
// console.log(solution);